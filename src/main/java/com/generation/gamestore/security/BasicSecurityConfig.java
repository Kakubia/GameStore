...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception{
		...
		.antMatchers("/user/login").permitAll() // De qualquer lugar, você terá acesso a login
		.antMatchers("/user/register").permitAll() // e cadastro já que as rotas estão abertas
